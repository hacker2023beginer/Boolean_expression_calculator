...
begin
  ...
  for var i := 0 to CounterMinterms - 1 do
    MasMinterm1[i] := MasTableTruthMinterms[i];          //можно после цикла сделать копию MasMinterm1
  ...
  SetLength(MasTableTruthMinterms, 0);
  SetLength(MasMinterm1, 0);
  SetLength(MasMinterm2, 0);
  SetLength(PrimeMinterms, 0);
  SetLength(AnswerPrimeMinterms, 0);
end;
